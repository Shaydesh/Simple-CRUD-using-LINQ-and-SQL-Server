...
namespace LINQ_example {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomersRow AddCustomersRow(int CustomerID, string FirstName, string LastName, string Gender, string City, string State) {
...
namespace LINQ_example.CustomerDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([CustomerID], [FirstName], [LastName], [Gender], [" +
                "City], [State]) VALUES (@CustomerID, @FirstName, @LastName, @Gender, @City, @Sta" +
                "te)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customers] SET [CustomerID] = @CustomerID, [FirstName] = @FirstName" +
                ", [LastName] = @LastName, [Gender] = @Gender, [City] = @City, [State] = @State W" +
                "HERE (([CustomerID] = @Original_CustomerID))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["Customer"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, FirstName, LastName, Gender, City, State FROM dbo.Customers";
        ...
        public virtual int Insert(int CustomerID, string FirstName, string LastName, string Gender, string City, string State) {
        ...
        public virtual int Update(int CustomerID, string FirstName, string LastName, string Gender, string City, string State, int Original_CustomerID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Gender, string City, string State, int Original_CustomerID) {
            return this.Update(Original_CustomerID, FirstName, LastName, Gender, City, State, Original_CustomerID);
        }
    }
